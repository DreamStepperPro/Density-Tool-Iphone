...
window.buildSupCard = function(title, dataObj, recentChecks, m) {
    ...
    <div class="sup-card ${isStale ? 'stale' : ''}">
        <div class="sup-header" style="align-items:center;">
            ...
            <button class="btn-icon" aria-label="View Detailed Logs" style="border:none; font-size:1.3rem; height:40px; width:40px; background:rgba(128,128,128,0.1); flex-shrink:0;" onclick="window.openSupHistory(${m})" title="View Detailed Logs">📋</button>
        </div>

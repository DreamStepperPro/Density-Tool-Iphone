...
window.renderHistoryCards = function() {
    ...
    if (!history || history.length === 0) {
        container.innerHTML = '<div style="text-align:center; opacity:0.5; padding:20px; font-size:0.85rem; font-style: italic;">' + (window.t('noHistory') || 'No shift history yet.') + '</div>';
        return;
    }

type="module">
    ...
    window.applyTranslations = function() {
        ...
        // Only re-render JS-injected UI if the app is actually running
    ...
    window.saveLocalSettings = function() {
        ...
        // lang is set directly on config before saveLocalSettings is called — always persist it
    ...
    // Persist notifiedSet in sessionStorage so page refresh doesn't re-toast pending requests

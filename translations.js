...
const i18n = {
    en: {
        ...
        noHistory: "No checks logged yet.", saveCheckPrompt: "Tap 'SAVE CHECK' to record lane weights.",
    ...
    es: {
        ...
        noHistory: "No hay registros aún.", saveCheckPrompt: "Toca 'GUARDAR' para registrar pesos.",

...
const i18n = {
    en: {
        ...
        helpDotText: "Shows live connection status. Green = syncing. Red = offline. Blue = pushing data. Tap it to force a radio reset if stuck.",
    ...
    es: {
        ...
        helpDotText: "Muestra el estado en tiempo real. Verde = sincronizando. Rojo = desconectado. Azul = enviando datos. Tócalo para forzar un reinicio de conexión si está atascado.",

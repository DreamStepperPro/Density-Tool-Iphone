...
const i18n = {
    en: {
        ...
        clearTable: "CLEAR TABLE", clearTableConfirm: "Clear shift history?", deleteEntryConfirm: "Delete this history entry?", emptyHistory: "No shift history recorded yet.", emptyHistoryYield: "No yield history saved yet.", lineAvg: "LINE AVG", lineSd: "LINE SD", options: "⚙️ Options",
        ...
        systemGuideBtn: "🧠 SYSTEM GUIDE", systemGuideTitle: "🧠 System Guide",
        helpDotTitle: "🟢 Status Dot & Connection Reset",
        helpDotText: "Shows live connection status. Green = syncing. Red = offline. Yellow = pushing data. Tap it to force a radio reset if stuck.",
        helpPveTitle: "⏱️ Predictive Velocity Engine (PVE)",
        helpPveText: "Anticipates drift before it happens. Watches your last 3 checks, calculates drift speed, and shows a countdown runway bar. Under 15 min: red alert. Under 5 min: vibrate + WEIGH NOW.",
        helpAdaptTitle: "🤖 SMART Adapt",
        helpAdaptText: "Auto-tunes density based on how your cutter is actually behaving. Activates after 2 misses. Ignores swings over 15g (woody breast, double-stack). Shuts off after 2 stable hits. Bails out after 5 consecutive failures — check the hardware.",
        helpSnipeTitle: "🎯 SMART-S (Snipe Override)",
        helpSnipeText: "Reduces department-wide STD across all machines. Supervisor broadcasts a target to your lane. Card glows red: FIX TO Xg. Card glows green: LOCKED ON TARGET. Density locks once you hit the pocket.",
        helpMatrixTitle: "🔧 Maintenance Matrix",
        helpMatrixText: "Log hardware faults as Degraded or Hard Down. Times are recorded to the OEE ledger. Tap 🧠 SMART ROUTE on a degraded cutter to see the optimal reassignment for remaining healthy cutters.",
        helpYieldTitle: "📊 Live Yield & Kerf Loss",
        helpYieldText: "Enter Fillets, Nuggets, and Trim. The app multiplies output by 1.03 to account for 3% waterjet kerf vapor loss — matching your company EOS reports. Trim over 22% turns red.",
        helpStreamTitle: "💧 Stream Test Compliance",
        helpStreamText: "Mandatory inspections at 1:10 AM, 3:45 AM, and 5:45 AM. Tap the banner, inspect the cutout, photo optional. Result is logged to the Supervisor Ledger with your name and timestamp.",
        ...
        copilotSurrender: "🚨 COPILOT SURRENDER:",
        copilotSurrenderDesc: "Mechanical scatter detected. Surrendered after 5 interventions.",
        machinePrefix: "Machine M",
        lanePrefix: "Lane",
        dsiPrefix: "DSI",
        snipeTarget: "🎯 SNIPE TARGET:",
        lockedOnTarget: "🎯 LOCKED ON TARGET",
        chronicOutlier: "⚠️ CHRONIC OUTLIER: Consistently pulling mean by",
        pullingDeptStd: "Pulling dept STD with",
        fromMean: "from mean",
        totalHardDown: "Total Hard Down (24h)",
        totalDegraded: "Total Degraded (24h)",
        limit: "Limit:",
    ...
    es: {
        ...
        clearTable: "BORRAR TABLA", clearTableConfirm: "¿Borrar historial del turno?", deleteEntryConfirm: "¿Eliminar este registro?", emptyHistory: "Aún no hay historial de turno registrado.", emptyHistoryYield: "Aún no hay historial de rendimiento guardado.", lineAvg: "PROM LÍNEA", lineSd: "SD LÍNEA", options: "⚙️ Opciones",
        ...
        systemGuideBtn: "🧠 GUÍA DEL SISTEMA", systemGuideTitle: "🧠 Guía del Sistema",
        helpDotTitle: "🟢 Punto de Estado y Reconexión",
        helpDotText: "Muestra el estado en tiempo real. Verde = sincronizando. Rojo = desconectado. Amarillo = enviando datos. Tócalo para forzar un reinicio de conexión si está atascado.",
        helpPveTitle: "⏱️ Motor de Velocidad Predictiva (PVE)",
        helpPveText: "Anticipa la desviación antes de que ocurra. Analiza tus últimos 3 pesos y muestra un contador de tiempo. Menos de 15 min: alerta roja. Menos de 5 min: vibración + PESAR AHORA.",
        helpAdaptTitle: "🤖 Adaptación SMART",
        helpAdaptText: "Ajusta la densidad según cómo responde tu cortador. Se activa tras 2 fallos. Ignora saltos mayores de 15g. Se apaga tras 2 aciertos estables. Se cancela tras 5 fallos seguidos — revisa el hardware.",
        helpSnipeTitle: "🎯 SMART-S (Anulación Snipe)",
        helpSnipeText: "Reduce la STD global de toda la planta. El Supervisor envía un objetivo a tu carril. Rojo: FIX TO Xg. Verde: OBJETIVO BLOQUEADO. La densidad se fija cuando alcanzas el rango.",
        helpMatrixTitle: "🔧 Matriz de Mantenimiento",
        helpMatrixText: "Registra fallas como Degradado o Parada. Se registra el tiempo exacto en el historial OEE. Toca 🧠 RUTA INTELIGENTE en un cortador degradado para ver la reasignación óptima.",
        helpYieldTitle: "📊 Rendimiento y Pérdida por Corte",
        helpYieldText: "Ingresa Filetes, Nuggets y Recorte. El sistema multiplica la salida por 1.03 para compensar el 3% de pérdida por vapor del chorro de agua — coincide con los reportes EOS de tu empresa. Recorte sobre 22% se vuelve rojo.",
        helpStreamTitle: "💧 Verificación de Prueba de Flujo",
        helpStreamText: "Inspecciones obligatorias a la 1:10 AM, 3:45 AM y 5:45 AM. Toca el banner, inspecciona el cartón, foto opcional. El resultado queda registrado en el Libro del Supervisor con tu nombre y hora.",
        ...
        copilotSurrender: "🚨 RENDICIÓN DEL COPILOTO:",
        copilotSurrenderDesc: "Dispersión mecánica detectada. Rendición tras 5 intervenciones.",
        machinePrefix: "Máquina M",
        lanePrefix: "Carril",
        dsiPrefix: "DSI",
        snipeTarget: "🎯 OBJETIVO SNIPE:",
        lockedOnTarget: "🎯 OBJETIVO BLOQUEADO",
        chronicOutlier: "⚠️ VALOR ATÍPICO CRÓNICO: Desviando constantemente la media por",
        pullingDeptStd: "Desviando el STD del depto. con",
        fromMean: "de la media",
        totalHardDown: "Inactividad Total (24h)",
        totalDegraded: "Degradado Total (24h)",
        limit: "Límite:",
